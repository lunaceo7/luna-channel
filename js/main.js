...
const SPEAKERS = [
  ...
  },
  {
    ...
    bio: [
      "月間5,000万円規模の広告運用、Meta広告による約4万件のリスト獲得、1回のプロモーションで1,000万円以上の売上を実現。",
      "Meta広告を中心とした広告運用から、リストマーケティング、公式LINE集客、プロモーション設計まで、Webマーケティングの実践領域を幅広く扱う。現在もGoogle広告・Yahoo!広告・Microsoft広告・Meta広告などを活用したマーケティング業務に携わっている。"
    ],
    facts: [
      { label: "広告運用", val: "月間5,000万円規模" },
  ...
  },
  {
    ...
    tags: ["副業", "占い"],
    bio: [
      "ルナCEOの受講生として学び・実践した経験をもとに、副業占い師として活動を展開。自身もココナラでゼロから占い販売を始めた経験を活かし、現在はこれから占い師として活動したい方へのサポートにも力を入れている。",
      "特にプロフィール・自己紹介文の添削や、「選ばれる見せ方」の言語化を得意とし、その方自身の経験や強みを引き出しながら、商品づくりから最初の売上につながるまで伴走。LUNAチャンネルでは、自身の実践経験をもとに『最初の1万円』をテーマとしたセミナーに登壇。"
    ],
    facts: [
      { label: "登壇", val: "第48回" },
      { label: "登録実績", val: "40名" }
...
const SEMINARS = [
     ...
     --------------------------------------------------------------- */
  {
    ...
    longDesc: [
      "五芒星(ペンタグラム)は火・水・風・地の四大エレメントと霊を表す図形、六芒星(ヘキサグラム)は太陽・月・惑星の力とつながる図形とされる。100年以上前から伝わる西洋魔術結社「黄金の夜明け団」では、五芒星を身のまわりの浄化・結界に、六芒星を天体の力を借りる場面にと使い分けてきた。",
  ...
  },
  {
    ...
    subtitle: "初心者でもできる「売れる導線」の作り方",
    speakerId: "ryuzaki",
    date: "2026-09-18",
    status: "upcoming",
    category: "マーケティング・集客",
    highlights: ["月間5,000万円規模の広告運用", "Meta広告による約4万件のリスト獲得", "1回のプロモーションで1,000万円以上の売上"],
    desc: "集客・マーケティングをテーマに、Webマーケティングの実践について扱うセミナー。Meta広告、リストマーケティング、公式LINE集客、プロモーション設計など、竜崎悠さんの専門領域を踏まえた内容。",
    longDesc: [
      "商品やサービスに自信があっても、その存在を知ってもらえなければ売上にはつながらない。本講座では、「誰に」「何を」「どうやって届けるのか」を整理し、集める→育てる→売るという一連の流れを、具体例を交えながら解説する。",
      "X・Instagram・Threads・Facebookなどを活用した集客から、公式LINE・メルマガによるリストマーケティング、広告を使った集客の加速方法まで扱う。オンラインだけでなく、アポイントや商談といったオフラインでの接点づくりについても取り上げる。",
      "専門知識は不要。マーケティングをほとんど学んだことがない方でも参加できる内容で、途中のワークでは自分のビジネスに落とし込んで考える時間も設ける。"
    ],
  ...
  },
  {
    ...
    category: "副業・収益化",
    registration: "登録40名",
    desc: "ココナラで副業占いを始めたい初心者に向け、最初の1万円を売り上げるまでに必要な準備と実践方法を紹介したセミナー。",
    longDesc: [
      "ココナラで副業占いを始めたい初心者に向け、最初の1万円を売り上げるまでに必要な準備と実践方法を紹介したセミナー。",
      "特に、プロフィール・自己紹介文の作り方や、その人自身の経験・強みを活かした商品設計、タイトル・サムネイル・価格設定など、「選ばれるための見せ方」を自身の実践経験をもとに解説した。"
    ],
  },
  {
    id: "s49",
...
function initIndexPage() {
  ...
  if (upcomingEl) {
    ...
    setText("#upcoming-count-badge", upcoming.length ? `${upcoming.length}件開催予定` : "");
  }
...
function initSeminarsPage() {
  ...
  if (upcomingEl) {
    upcomingEl.innerHTML = upcoming.length
      ? upcoming.map(upcomingSeminarCard).join("")
      : `<div class="empty-state">現在、確定している開催予定はありません。</div>`;
    setText("#upcoming-count-badge-seminars", upcoming.length ? `${upcoming.length}件開催予定` : "");
  }
